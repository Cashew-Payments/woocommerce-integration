...
class Request
{
     ...
     */
    const API_URL = 'https://<subdomain>.cashewpayments.io';

    /**
     * @const string Accept HTTP header.
     */
    const ACCEPT_HEADER = 'application/vnd.cashewpayments+json; version=';
    ...
    public function __construct(
        ...
        $this->params = $params;
        $this->auth = $auth;
        $this->apiVersion = $apiVersion ?: Cashewpayments::DEFAULT_API_VERSION;
    ...
    public function getDefaultHeaders()
    {
        return [
            ...
            'User-Agent' => 'cashewpayments-php:' . Cashewpayments::VERSION,
        ];
    }
    ...
    {
        return $this->apiVersion === Cashewpayments::GRAPHQL_VERSION;
    }
