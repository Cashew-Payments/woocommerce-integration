...
function onMessage(e)
{
    ...
    "hideOverlay" === o ?  document.body.querySelector(".sptii-overlay") ? setTimeout(
        function () {
            removeOverlay()}, 5000
    ) : "" : "redirectToSpotii" === o && n ? setTimeout(
        (function () {
                window.location = n
        }), 1e3
    ) : "function" == typeof window[o.func] && window[o.func].call(null, o.message)
}
...
function openIFrame()
{
    ...
    (function (root, document) {
        ...
        [].forEach.call(
            document.getElementsByClassName("lightbox"), function (el) {
                el.lightbox = new IframeLightbox(
                    el, {
                        onCreated: function () {
