<?php
/**
 * Cashewpayments split payment settings
 */
...
return array(
	'enabled'            => array(
		...
		'type'    => 'checkbox',
		'label'   => __( 'Enable Split Payment', 'cashewpayments' ),
		'default' => 'yes',
	),
	'title'              => array(
		...
		'default'     => __( 'Instalments with Cashewpayments', 'cashewpayments' ),
		'desc_tip'    => true,
	),
	'description'        => array(
		...
		'default'     => __( 'Buy now and pay later with zero interest and zero fees.', 'cashewpayments' ),
	),
	'merchant_id'        => array(
	...
	'product_widget'     => array(
		'title'       => __( 'Product widget', 'cashewpayments' ),
		'type'        => 'checkbox',
		'label'       => __( 'Enable product widget', 'cashewpayments' ),
		'default'     => 'yes',
		'description' => __( 'Show a promotional message on product pages.', 'cashewpayments' ),
	),
	'cart_widget'        => array(
		'title'       => __( 'Cart widget', 'cashewpayments' ),
		'type'        => 'checkbox',
		'label'       => __( 'Enable cart widget', 'cashewpayments' ),
		'default'     => 'yes',
		'description' => __( 'Show a promotional message on cart page.', 'cashewpayments' ),
	),
	'cashewpayments_widget'     => array(
